...
class TodoItem extends Component {
  ...
  //Since there is no state manager like redux or the content API we have to bind the function to the props 
  //then write the function one level up from here and then until we reach the app.js where the state
  //is 
